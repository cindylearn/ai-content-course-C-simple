...
3. **（课上·用 `01-branding`）定落脚点 + 喂地基** —— 🔴 **这一步不在 00（00 只装机），是 01 从零搭系统时做的**：先给他一个「家」—— 开一个成品 folder（图/视频/文案存这，默认 `~/我的AI内容营销/<品牌>`）+ 定用哪个 Notion + Drive folder；再把品牌名 / 受众 / 红线 / 品牌色 写进 memory + 业务 md，搭好 Notion 大脑。之后每次开工 Claude 先读它。
...
| **ChatCut** | 影片后期：字幕 / 花字 / 音效 / BGM —— **中文片唯一可行的 AI 剪辑路**（生成 ≠ 成品）。新用户免费送 15 credit，够剪第一支 | ✅ 出视频就要 |
