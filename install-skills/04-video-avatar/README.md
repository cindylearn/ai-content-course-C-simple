...
> - **C · 只有声音档（mp3／mp4 的声音，没有脸）** → **配数字人对嘴**：`generate_audio:false` ＋ 声音档进 `audio_references`，脸选真人样子／AI 人／卡通人。🔴 **绝不走路线 A** —— A 会自己生一把声，把他录好的声音丢掉
> - **A · 从零生成** → 有脚本，画面＋声音都由 AI 生（480p+fast 约 1.5 cr／秒，最便宜）
>
