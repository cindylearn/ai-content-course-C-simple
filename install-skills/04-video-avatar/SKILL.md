...
description: >-
 SUMA AI 内容系统 · 第 04 步 · 口播短视频。两条路都在这里：
 **A 从零生成**（有脚本 → AI 生成每一镜，含数字人：选AI人/真人样子/卡通人）·
 **B 重绘已录好的片**（你自己录的真人片 → 换妆/换衣服/换发型/换背景/换机位，**声音用原片的**）。
 触发词：口播视频 / 做视频 / 短视频 / video / 分镜 / 数字人 / 数字分身 / avatar / 数字主播 /
 换造型 / 换衣服 / 换背景 / 换妆 / 换发型 / 换机位 / 换角度 / 重绘视频 / 我自己录了片 / 用原声 / 原片配音。
 跟用户对话一律用中文；教练式一题一题问。
metadata:
 type: reference
