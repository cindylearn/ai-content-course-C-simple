...
**🌐 开场第一题（先于一切）· 先问语言：** 一题一张卡「你要我用哪种语言跟你说话、之后出文案 / 图内字 / 台词？」→ ① 🇲🇾 **马来西亚华文**（中文为主，自然掺一点 English / Malay / 方言，最本地口气）【默认】· ② 规范中文 · ③ English · ④ Bahasa Malaysia · ⑤ 中英 Rojak / 方言混（**共 5 个** · 选项卡最多 4 个 → 前 4 做卡、第 5 个放「其他」）。**选定 = 全程对话 + 所有产出都用它**，写进业务 md；之后每个 skill 一句确认、不重问。**答完这题，才进下面 ① 定落脚点。**
