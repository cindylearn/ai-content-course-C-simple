---
name: suma-ai-06-music
description: >-
 SUMA AI 内容系统 · 第 06 步。用 Suno + Claude 做垫底 BGM 或品牌歌，存进 Notion 音乐库。
...
# suma-ai-06-music —— 用 Suno + Claude 做垫底 BGM 或品牌歌，存进 Notion 音乐库。

## 🔑 怎么触发这个 skill（两种方式，任选一个）

| 方式 | 打什么 |
|---|---|
| ① 斜杠（最稳·直接点名）| `/suma-ai-06-music` |
