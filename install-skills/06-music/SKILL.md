...
> - 答完这题才问下一题；答完一组才动手做
>
> 🌐 **开工第一题 · 先问语言（每个 skill 都先问 · 必带马来西亚华文选项）：** 一题一张卡问「你要我用哪种语言跟你说话、出文案/图内字/台词？」：① 🇲🇾 **马来西亚华文**（中文为主，自然掺一点 English / Malay / 方言，最本地口气）【默认】· ② 规范中文 · ③ English · ④ Bahasa Malaysia · ⑤ 中英 Rojak / 方言混（**共 5 个** · 选项卡最多 4 个 → 前 4 做卡、第 5 个放「其他」）。选定 = **全程** Claude 对话 + 出的文案 / 图内字 / 台词都用它、语气统一。**业务 md 已记 → 一句确认，别重问。**
> **统一提问顺序（固定，别临时调换）：** 第一题 · 🌐语言 → 第二题 · 做哪个受众 → 第三题 · 哪个漏斗层（ToFu/MoFu/BoFu）→ 第四题起 · 本 skill 专属。语言 / 受众 / 漏斗层若业务 md 已记 → 一句确认、不重复问。
