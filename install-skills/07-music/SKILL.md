...
> - 答完这题才问下一题；答完一组才动手做
>
> 🌐 **开工第一题 · 内容用哪种语言（每个 skill 都先问 · 必带马来西亚华文）：** 🔴 **跟学员对话你一律用中文**（不管他选什么）；这一题只定**出的内容**（文案 / 图内字 / 台词）用哪种语言。一题一张卡问「你要出的**文案 / 台词**用哪种语言？」：① 🇲🇾 **马来西亚华文**（中文为主，自然掺一点 English / Malay / 方言，最本地口气）【默认】· ② 规范中文 · ③ English · ④ Bahasa Malaysia · ⑤ 中英 Rojak / 方言混（**共 5 个** · 选项卡最多 4 个 → 前 4 做卡、第 5 个放「其他」）。选定 = **出的文案 / 图内字 / 台词**都用它（**对话仍中文**）。**业务 md 已记 → 一句确认，别重问。**
