...
🔴🔴 **04 里出现的人 = 脚本 persona（贴目标受众）+ 05 给的脸参考图定死**；用户在 04 只能选语言、不挑人；脸从 `suma-ai-05-avatar` 来（AI 数字人 or 真人数字人）。**选人、九宫格、性别气质 —— 全部只在 05。**
🔴 **开工只确认两件（一题一张选项卡，别默认）：**
1. **脸参考图齐了吗** —— 有真人用真人 3 张脸；没有 → 先去 `suma-ai-05-avatar` 做/选、拿 3 张脸回来。
