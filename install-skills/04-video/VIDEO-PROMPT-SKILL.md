...
### Round 1 — 脸参考图 + 语言（🔴 04 不选人）

> 主角**贴目标受众**（受众是谁就长那样），**不在 04 选** —— 性别/年龄/气质/选几号脸全在 `05 AI数字人`。04 只拿锁好的脸、问语言。

**Q1. 脸参考图齐了吗？/ Face references ready?**
1. 有真人本尊 → 用他 3 张脸 / Real person's 3 face shots
2. 用 05 做的数字人 → 拿 05 锁好的 3 张脸 / 05's locked digital human
> 都没有 → 先去 `05 AI数字人` 做/选，拿 3 张脸回来再继续。

**Q2. 说话语言 / Language**（一定要问，别默认英文）
