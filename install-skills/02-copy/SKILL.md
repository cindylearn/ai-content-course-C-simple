...
> - **② 标题**：第一行是**带钩子的强标题**，末尾放 **1 个** emoji。🔴 **绝不用【】方括号**（不写「【…】」）—— 直接把那句钩子写出来。🔴 **钩子必须紧扣你核心产品/服务**（戳它正好解决的那个痛点、一句带出核心，别写泛痛点 —— 详见下方「§二 · 钩子铁律」）。
...
> 🔴🔴 **钩子铁律 · 必须紧扣核心产品/服务（每条都守）：** 钩子标题戳的那个痛点 / 角度，**必须正好是你核心产品/服务解决的那一个** —— **一句话就把核心带出来**，让人一看就知道「这跟他要卖的东西直接相关」。
> - ✅ 卖 **AI 超级助理（自动 dashboard / 群总结 / proposal）** → 钩子戳「群里问半天没人回、数字要等月底才拼得出来」（正好这产品解决）。
> - ✅ 卖 **补习** → 钩子戳「越补越怕 / 背答案不懂」（正好补习解决）。
> - ❌ 别写**跟核心无关**或**太泛**的痛点（「做生意好累」「现在竞争好大」谁都能发，带不出你的核心 = 废钩子）。
> 🔴 动笔前先读业务 md 的「**一句话生意 + 主打产品/服务**」，钩子就从「**这个核心正好解决的那个最痛的点**」切进去。
