...
以上四步齐了 → 说「地基 OK，我们来做第一条内容」，然后**一次一题**问（选项卡）：
1. **做哪个受众？**（列品牌地基里定的受众）
...
🔴 先照模版建这条立项页、填好、Status 走起，**再产出；进 02/03/04 一律自动套那个 skill 的完整 SOP**。🔴 数字人/PPT/配乐不是「主 part」——是视频/内容的配件，需要时在流程里带出，别当独立选项让学生选。**四步没齐 → 不放行。**
