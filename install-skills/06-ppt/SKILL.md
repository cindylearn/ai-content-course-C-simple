...
> 🔴🔴 **06-ppt 开工先问这两题（在语言 / 受众之前 —— 覆盖下面的统一顺序，PPT 专属）：**
> **① 这份 PPT 是关于什么？给哪个业务 / 主题做？** 🔴 **绝不默认＝业务 md 里那个生意！** PPT 常常是**一次性、针对某个具体主题**的（一个客户提案 / 一个产品 / 一份数据汇报 / 一个课题），**主题可能跟你的内容营销生意完全不一样**。用一张卡问：`① 就是我业务 md 的生意（读 md 一句确认）· ② 别的主题 / 业务（让他一句话说清是什么、给谁）· ③ 其他`。**读到 md 也要问这一题、等他选，别读了就默认。**
> **② 这份 PPT 做什么用（目的 / 场景）？** 决定套哪个演示大师框架 —— 一张卡：`销售提案·成交（Monroe/OPA）· 客户汇报·决策（BLUF/SCQA）· 教学·培训（BOPPPS/4MAT）· 投资路演 · 招商 · 内部汇报 · 其他`。
> 这两题定了 → 再进下面的语言 / 受众 / 内容。
>
