...
**Q1. 要哪种数字人？（二选一 · 选项卡）**
1. **AI 数字人**（AI 凭空生成一个人，不是真人本尊）→ 进 Q2 选 model + Q3 九宫格选脸。🔴 **性别/年龄/气质照你的目标受众来定**（受众是谁，主播就长那样）。
2. **真人数字人**（照某个真人本尊做 —— 长得像他 + 用他的声音）→ 让他提供下面 3 样素材，用照片锁脸 + 语音克隆声。
...
**Q2.（选了 AI 数字人才问）用什么 model 出人物图？给选项 + 说清 credit：**
...
**Q3.（选了 AI 数字人才做）九宫格选脸 + 定妆照锁脸** —— 两步，中间停下等用户选（这套模板 05 自带，不用翻别包）：
